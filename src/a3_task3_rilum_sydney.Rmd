...
**Figure 1.** Wordcloud containing the most frequently used words in Louisa May Alcott's *Little Women*. Note that character names were removed from word counts.
...
ggplot(data = afinn_means, 
  ...
  labs(x = "Chapter",
       y = "Mean AFINN score",
       title = "Little Women Sentiment Analysis") +
  theme(legend.position = "none")

```

**Figure 2.** A bar graph displaying mean AFINN scores for the words in each chapter of *Little Women*, according to the AFINN sentiment lexicon classifications. The AFINN lexicon ranks words from -5 (very negative sentiment) to +5 (very positive sentiment). Blue bars indicate chapters containing words with positive mean sentiments scores and red bars indicate chapters containing words with negative mean sentiments.

<br>

**Text Citation:** [Alcott, Louisa M. *Little Women: or Meg, Jo, Beth, and Amy.* Little, Brown, and Company, 1916.](https://archive.org/details/littlewomen00alcoiala/page/n7/mode/2up)

**Sentiment Citation:** [Finn Årup Nielsen A new ANEW: Evaluation of a word list for sentiment analysis in microblogs. Proceedings of the ESWC2011 Workshop on 'Making Sense of Microposts': Big things come in small packages 718 in CEUR Workshop Proceedings 93-98. 2011 May.](http://arxiv.org/abs/1103.2903.)
